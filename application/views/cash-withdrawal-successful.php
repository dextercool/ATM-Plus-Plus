...
<html lang="en" class="no-js">
	...
	<body>
		...
		<div class="supported"> 
			<div class="container">
				...
				<div class="main clearfix">
					...
					<div class="column">
						<p style="font-size:29px;text-align:left;display:block;margin-top:20px;">
							<span style="width:100%;text-aligh:center;font-size:35px;margin-left:20px;">Transaction Successful</span>
							<br/>
		...
		<div class="supported"> 	
			<script>
				$.playSound('http://translate.google.com/translate_tts?tl=en&q=Your%20cash%20has%20been%20successfully%20withdrawn.%20And%20Now%20you%20have%20,<?php echo $account_balance; ?>%20rupees%20in%20your%20account');
			</script>
	<!--	<audio id="sound1" autobuffer src="<?php echo base_url(); ?>audio/login/6.mp3"></audio>-->
