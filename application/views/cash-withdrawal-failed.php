...
<html lang="en" class="no-js">
	...
	<body>
		...
		<div class="supported"> 
			<div class="container">
				...
				<div class="main clearfix">
					...
					<div class="column">
						<p style="font-size:29px;text-align:left;display:block;margin-top:20px;">
							<span style="width:100%;text-aligh:center;font-size:35px;margin-left:20px;">Transaction Failed</span>
							<br/>
							<span style="width:100%;text-aligh:center;font-size:35px;margin-left:20px;">You have insufficient funds</span>
							<br/>
							<span style="width:100%;text-aligh:center;font-size:35px;margin-left:20px;">Account Balance: <?php echo $account_balance; ?> INR</span>
							<br/>
		...
		<div class="supported"> 	
			<script>
				$.playSound('http://translate.google.com/translate_tts?tl=en&q=Cash%20withdrawal%20has%20been%20failed%20due%20to%20unsufficient%20amount%20in%20your%20account');
			</script>		
	<!--	<audio id="sound1" autobuffer src="<?php echo base_url(); ?>audio/login/7.mp3"></audio> -->
