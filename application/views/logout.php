	  ...
	  Your browser doesn't support Web Speech API. Please use Google Chrome.
		...
		<div class="md-modal md-effect-11" id="modal-11">
			<div class="md-content">
				...
				<div>
					...
					<ul>
						...
						<li><strong>Project:</strong> LUSIP12 ATM++</li>
						<li><strong>Developed by:</strong> Aaditya Sharma</li>
		 ...
		 <div class="supported"> 
				<div id="top">
					<div class="container">
						<!--<span>Developed By: Aaditya Sharma</span> -->
					</div>
				</div>

				<div class="container">
					<header>
						<h1>LUSIP - ATM++ <span>A VUI based banking solution | 24x7 At your service </span></h1>
					</header>
				...
				<footer>
					<div class="container">
						<span>Developed By: Aaditya Sharma &nbsp;&nbsp; | &nbsp;&nbsp; All Rights Reserved</span>
					</div>
				</footer>
				
				<audio id="sound1" autobuffer src="<?php echo base_url(); ?>audio/login/1_2.mp3"></audio>
		</div>
